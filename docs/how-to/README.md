...
These guides assume an installed PCVMF environment and a concrete task. For a guided introduction, use the [tutorials](../tutorials/README.md).
...
- [Migrate a 0.2 application to 0.3](migrate-to-0.3.md).
